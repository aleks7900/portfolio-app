  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        emerald:
          "border-transparent bg-emerald-500/15 text-emerald-600 dark:text-emerald-400 dark:bg-emerald-500/20",
        amber:
          "border-transparent bg-amber-500/15 text-amber-600 dark:text-amber-400 dark:bg-amber-500/20",
        sky:
          "border-transparent bg-sky-500/15 text-sky-600 dark:text-sky-400 dark:bg-sky-500/20",
      },
    },
    defaultVariants: {
      variant: "default",
