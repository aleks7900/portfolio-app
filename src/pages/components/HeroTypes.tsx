                        ...
                        >
                            {[0, 1, 2, 3].map((i) => (
                                ...
                                >
                                    ...
                                    {i === 0 && <ServiceCardOdd titleKey="aisi_304_title"
                                                                descKey="aisi_304_desc" s={SERVICES[12]}/>}
                                    {i === 1 && <ServiceCard titleKey="aisi_316_title"
                                                             descKey="aisi_316_desc" s={SERVICES[13]}/>}
                                    {i === 2 && <ServiceCard titleKey="aisi_321_title"
                                                             descKey="aisi_321_desc" s={SERVICES[14]}/>}
                                    {i === 3 && <ServiceCardOdd titleKey="aisi_430_title"
                                                                descKey="aisi_430_desc" s={SERVICES[15]}/>}
                                </motion.div>
                            ))}
                        </motion.div>
                    </motion.div>
