                    ...
                    <motion.div variants={cardVariants}
                        ...
                        <motion.div initial="hidden" animate="visible"
                            ...
                            {[0, 1, 2, 3].map((i) => {
                                ...
                                return (
                                    <motion.div key={i} variants={cardVariants} whileHover={{y: -2}}
                                                whileTap={{scale: 0.995}} className="card-appear shimmer-wrap"
                                                onMouseMove={onMouseMove} onMouseLeave={onMouseLeave} ref={ref}
                                                style={{perspective: 900}}>
                                        <motion.div className="shimmer-inner"
                                                    style={{transformStyle: "preserve-3d", willChange: "transform"}}
                                                    animate={{rotateX: rot.rx, rotateY: rot.ry}} transition={{
                                            type: "spring",
                                            stiffness: 220,
                                            damping: 18,
                                            mass: 0.5
                                            ...
                                            <div className="card-icon-anim">
                                                ...
                                                {i === 1 && <ServiceCard titleKey="services_stiffener_title"
                                                                         ...
                                                                         s={SERVICES[9]}/>}
                                                {i === 2 && <ServiceCard titleKey="services_leg_title"
                                                                         descKey="services_leg_desc" s={SERVICES[10]}/>}
                                                {i === 3 && <ServiceCardOdd titleKey="services_acid_title"
