...
export default function AdvantageCard({
  ...
  return (
    <SpatialCard className="h-full">
      <div className="group relative flex flex-col justify-between rounded-2xl border border-border/80 bg-card/85 dark:bg-card/60 p-6 shadow-xs hover:shadow-xl hover:border-emerald-500/40 backdrop-blur-sm transition-colors duration-300 min-h-full [transform-style:preserve-3d]">
        <div className="[transform-style:preserve-3d]">
          <div className="flex items-center gap-3 [transform:translateZ(14px)]">
            <div className="inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 dark:bg-emerald-500/20 transition-transform duration-300 group-hover:scale-105 [transform:translateZ(18px)]">
