...
// Импорт фона: Vite подставит корректный URL
import bgImage from "../assets/img/bg.jpeg";

export default function MainPage() {
    return (
        <div className="relative min-h-screen">
            {/* HERO: фон + контент поверх него */}
            <section className="relative h-[420px] sm:h-[800px] lg:h-[900px]">
                {/* Фон (картинка, полупрозрачность, маска слева→направо) */}
                <div
                    aria-hidden="true"
                    className="absolute inset-0 z-0 pointer-events-none bg-no-repeat bg-top opacity-60 blur-[5px]"
                    style={{
                        backgroundImage: `url(${bgImage})`,
                        backgroundSize: "100% auto", // ширина 100%, высота авто
                ...
                <div className="relative z-10">
                    <div className="mt-12 min-h-[1rem]" />
                    <HomeSearch />
                    <div className="mt-4" />
                    <Slideshow />
                </div>
                ...
                <div className="hidden">
                    ...
                    "R.V.P. 11 Поручень для унитаза ( стационарный)" = "R.V.P. 11 Poruchen dlya unitaza (
                    statsionarnyy)"
                    "R.V.P. 12 Поручень для унитаза ( откидной с фиксатаром )" = "R.V.P. 12 Poruchen dlya unitaza (
                    otkidnoy
                    s fiksatarom )"
                    "R.V.P. 13 Поручень опорный наполный ( откидной с фиксатаром )" = "R.V.P. 13 Poruchen opornyy
                    napolnyy (
                    otkidnoy s fiksatarom )"
                    "R.V.P. 14 Поручень для санузла ( Ванна, унитаз, писуар)" = "R.V.P. 14 Poruchen dlya sanuzla (
                    Vanna,
                    unitaz, pisuar)"
                    "R.V.P. 15 Поручень для санузела ( ванна, унитаз, писуар)" = "R.V.P. 15 Poruchen dlya sanuzela (
                    vanna,
                    unitaz, pisuar)"
                    "R.V.P. 16 Поручень для санузела ( ванна, унитаз, писуар)" = "R.V.P. 16 Poruchen dlya sanuzela (
                    vanna,
                    unitaz, pisuar)"
                    "R.V.P. 17 Поручень для санузела ( ванна, унитаз, писуар)" = "R.V.P. 17 Poruchen dlya sanuzela (
                    vanna,
                    unitaz, pisuar)"
                    ...
                    "R.V.P. 24 Поручень опорный для раковины, 3 точки опоры" = "R.V.P. 24 Poruchen opornyy dlya
                    rakoviny, 3
                    tochki opory"
                    ...
                    "R.V.P. 27 Поручень для мини-раковины с 4-мя точками опоры" = "R.V.P. 27 Poruchen dlya mini-rakoviny
                    s
                    4-mya tochkami opory"
                    "R.V.P. 28 Поручень для ванны 3-х опорный" = "R.V.P. 28 Poruchen dlya vanny 3-kh opornyy"
                    "R.V.P. 29 Опорное устройства с подднржкой спины с откидными поручнями" = "R.V.P. 29 Opornoe
                    ustroystva
                    ...
                    Vnutreniy ugol"
                    "R.V.P. 6 Поручень для ванны, туалета. Внешний угол" = "R.V.P. 6 Poruchen dlya vanny, tualeta.
                    Vneshniy
                    ugol"
                    ...
                    "R.V.P. 9 Поручень для раковины с опорой к стене" = "R.V.P. 9 Poruchen dlya rakoviny s oporoy k
                    stene"
                    ...
                    "R.V.8" = "R.V.8"
                    "R.V.9" = "R.V.9"
                    "Стандартные операцие ( расценки ) для изготовления стола" = "Standartnye operatsie ( rastsenki )
                    dlya
                    izgotovleniya stola"
                    ...
                    "Праис на операций для изготовления данного типа стола" = "Prais na operatsiy dlya izgotovleniya
                    dannogo
                    tipa stola"
                    ...
                    "Estante Mensula Sup_ Upper bracket shelf on Behance_files" = "Estante Mensula Sup_ Upper bracket
                    shelf
                    on Behance_files"
